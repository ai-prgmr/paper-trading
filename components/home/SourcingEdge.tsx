...
export function SourcingEdge() {
  const values = [
    {
      title: "Process Excellence",
      description: "Intelligent Process Technology for Responsible Sourcing.",
        ...
        <div className="lg:col-span-7 space-y-8">
          <div>
            ...
            <div className="space-y-4 text-on-surface-variant font-body-md text-sm md:text-base leading-relaxed opacity-95">
              ...
              <p>
                The company’s operations are anchored in a recycling-led sourcing ecosystem, where high-performance, wastepaper-based packaging boards and virgin-grade boards are procured from leading global and domestic mills. This extensive network enables GL Trading Company to serve both sustainable and premium packaging requirements with equal confidence and reliable supply.
              </p>
            </div>
          </div>
        ...
        <div className="lg:col-span-5 relative w-full h-[450px] sm:h-[550px] lg:h-[600px]">
          ...
          <div className="relative w-full h-full rounded-2xl overflow-hidden border border-border shadow-xl hover:shadow-2xl transition-shadow duration-300">
            <Image
              ...
              alt="GL Trading Company Advanced Logistics and Storage"
              fill
