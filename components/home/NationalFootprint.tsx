      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant mb-12">
            With over eight decades of business legacy, G L Paper Trading has established a robust distribution network spanning across 18+ states. We bridge the gap between large-scale mills and local packaging manufacturers.
          </p>
